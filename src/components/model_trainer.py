    ...
    def initiate_model_training(self,train_array,test_array):
        try:
            ...
            models= {
                ...
                'RandomizedSearchCV':RandomizedSearchCV(RandomForestClassifier(n_estimators=50), param_distributions=param_dist, n_iter=8,cv=3)
            ...
            logging.info('Exception occured at model Trainine')
